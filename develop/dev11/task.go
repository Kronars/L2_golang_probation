...
В рамках задачи необходимо:
	...
	3.5 ❌ Web-сервер должен запускаться на порту указанном в конфиге и ✅ выводить в лог каждый обработанный запрос.
...
func main() {
	...
	fmt.Printf("[info] Сервер запущенн по адресу %s:%d\n", HOST, PORT)
